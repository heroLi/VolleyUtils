 ...
 * 
 * @author 18834
 * @param EhaiJsonArrayResponse<T> 
 * **/
public class EhaiGsonArrayRequest<T> extends Request<T> {
	...
	public EhaiGsonArrayRequest(String url, Listener<T> listener,ErrorListener errorListener,
			Class rep) {
		this(Method.GET, url, null, listener,errorListener, rep);
	}

	public EhaiGsonArrayRequest(int method, String url, String par,
			Listener<T> listener,ErrorListener errorListener, Class rep) {
	...
	protected Response<T> parseNetworkResponse(NetworkResponse response) {
		...
		try {
			...
			return (Response<T>) Response.success(gson.fromJson(data, type),
